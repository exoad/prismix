        ...
        extends JSplitPane
{
            ...
            extends JSplitPane
    {
        ...
        public Container_TopPane()
        {
            ...
            colorDisplay_G
                    .setBorder(colorDisplay.getBackground().getGreen() / 255F < _2const.COLOR_BLEND_THRESHOLD_BORDER
                            ? BorderFactory
                                    .createLineBorder(
            ...
            colorDisplay_B
                    .setBorder(colorDisplay.getBackground().getBlue() / 255F < _2const.COLOR_BLEND_THRESHOLD_BORDER
            ...
            miscAttributes
                    .setBorder(
                            BorderFactory.createTitledBorder(BorderFactory.createEmptyBorder(5, 0, 5, 0), "-- MISC"));
                ...
                SwingUtilities.invokeLater(() -> {
                    if (rgbData.isVisible())
                    {
                        ...
                        colorDisplay_R.setBorder(BorderFactory
                                .createLineBorder(
                                        new Color((255F - colorDisplay.getBackground().getRed()) / 255F, 0F, 0F), 2));
                        ...
                        colorDisplay_G
                                .setBorder(BorderFactory
                                        .createLineBorder(
                                                new Color(0F, (255 - colorDisplay.getBackground().getGreen()) / 255F,
                                                        0F),
                                                2));
                        ...
                        colorDisplay_A.setBorder(
                                BorderFactory.createLineBorder(
                                        new Color((255F - colorDisplay.getBackground().getRed()) / 255F,
                                                (255F - colorDisplay.getBackground().getGreen()) / 255F,
                        ...
                        rgba_R
                                .setText(" Red   (R):  " + x.getRed() + " ["
                                        + String.format("%,.2f", 100 * x.getRed() / 255F) + "%]");
                        rgba_R.setToolTipText("Red   (R):  " + x.getRed() + " [" + 100 * x.getRed() / 255F + "%]");
                        colorDisplay_G.setToolTipText(rgba_G.getToolTipText());

                        rgba_G.setText(
                                " Green (G):  " + x.getGreen() + " ["
                                        + String.format("%,.2f", 100 * x.getGreen() / 255F) + "%]");
                        ...
                        rgba_A.setText(
                                " Alpha (A):  " + x.getAlpha() + " ["
                                        + String.format("%,.2f", 100 * x.getAlpha() / 255F) + "%]");
                    ...
                    if (miscAttributes.isVisible())
                    {
                        ...
                        hexColor.setText(
                                "Hex: " + stl_Colors.RGBAtoHex(x.getAlpha(), x.getRGB(), x.getGreen(), x.getBlue()));
