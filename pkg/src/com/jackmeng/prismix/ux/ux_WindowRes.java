		...
		MouseAdapter
{
	...
	private static final HashMap< Integer, Integer > cursors = new HashMap<>();
	static
	{
	...
	public ux_WindowRes(Component... components)
	{
		this(new Insets(5, 5, 5, 5), new Dimension(1, 1), components);
	}

	public ux_WindowRes(Insets dragInsets, Component... components)
	{
		this(dragInsets, new Dimension(1, 1), components);
	}

	public ux_WindowRes(Insets dragInsets, Dimension snapSize, Component... components)
	{
